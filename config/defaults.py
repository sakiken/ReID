...
_C.MODEL.PRETRAIN_PATH = ' /root/project/reid-strong-baseline/weights/r50_ibn_2.pth'
...
_C.TEST.WEIGHT = "/root/project/reid-strong-baseline/logs/resnet50_ibn_a_model_30.pth"
...
_C.OUTPUT_DIR = "/root/project/reid-strong-baseline/logs"
